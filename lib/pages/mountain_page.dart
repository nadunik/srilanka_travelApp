...
class MountainPage extends StatefulWidget {
  const MountainPage({Key? key}) : super(key: key);

  @override
  _MountainPageState createState() => _MountainPageState();
}

class _MountainPageState extends State<MountainPage> with TickerProviderStateMixin {
  var images = {
      ...
      body: /*BlocBuilder<AppCubits, CubitStates>(
        ...
        children: [
          ...
          Container(
            ...
            child: AppBoldText(text: "Mountains"),
          ),
          SizedBox(height: 20),
          //tabbar
          Container(
