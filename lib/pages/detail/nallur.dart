...
class NallurPage extends StatelessWidget {
  const NallurPage({Key? key}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "Nallur (Tamil: நல்லூர்; Sinhala: නල්ලූර්) is an affluent suburb in Jaffna, Sri Lanka. It is located 3 km south from Jaffna city centre.[1] Nallur is most famous for Nallur Kandaswamy temple, one of Sri Lanka's most sacred place of pilgrimage for Sri Lankan Hindus.[1][2] Nallur is also famous for being the historical capital of the old Jaffna Kingdom and birthplace of renowned philosopher and theologian, Arumuka Navalar.")
