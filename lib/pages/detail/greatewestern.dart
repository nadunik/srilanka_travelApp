...
class GWesternPage extends StatelessWidget {
  const GWesternPage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"Great Western", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "Great Western Mountain is the 8th highest mountain in Sri Lanka. It is located in Nuwara Eliya District. Its trail is ranked as difficult due to its steep incline and difficult, unclear path")
