...
class StclairsPage extends StatelessWidget {
  const StclairsPage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"St. Clair's Fall", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "St. Clair's Falls (Sinhala: සාන්ත ක්ලෙයාර් ඇල්ල) is one of the widest waterfalls in Sri Lanka and is commonly known as the Little Niagara of Sri Lanka. It is one of six waterfalls affected by the Upper Kotmale Hydropower Project.The falls are situated 3 kilometres (1.9 mi) west of the town of Talawakele on the Hatton-Talawakele Highway in Nuwara Eliya District.")
