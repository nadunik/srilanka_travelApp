...
class HikkaduwaPage extends StatelessWidget {
  const HikkaduwaPage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"Hikkaduwa Beach", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "The beaches are beautiful and wide and swimming is safe here, although the currents are stronger when it comes south of Hikkaduwa. The impressive coral reef lies just offshore and is still populated with exotic fish and sea turtles.")
