...
class KandalamaPage extends StatelessWidget {
  const KandalamaPage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"Kandalama Lake", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "The Kandalama Reservoir (also erroneously known as the Kandalama Lake) is a reservoir in Kandalama, Sri Lanka. The reservoir is created by the 21 m (69 ft) high and 1,600 m (5,200 ft) wide Kandalama Dam. Water from the dam is used for irrigation purposes in the region, extending up to Kekirawa.[1] The tank was created by constructing a dam across one of the main tributaries of Kala Wewa - the Mirisgoniya River.")
