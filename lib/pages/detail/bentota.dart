...
class   BentotaPage extends StatelessWidget {
  const BentotaPage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"Bentota Beach", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "Bentota, 62km south of Colombo, is a planned tourist development. It has a long broad sandy beach, at its best during the October to April holiday season, with safe swimming – although red warning flags fly when currents are too strong.")
