...
class ArugamBayPage extends StatelessWidget {
  const ArugamBayPage({Key? key}) : super(key: key);
  
  final int gottenStars=5;
                ...
                Positioned(
                  ...
                  child: Row(
                    children: [
                      IconButton(
                        onPressed: () {
                          Navigator.pushNamed(context, '/destination2');
                        },
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "Arugam Bay (Tamil: அறுகம் குடா), known locally as Arugam Kudah, is situated on the Indian Ocean in the dry zone of Sri Lanka's southeast coast, and a historic settlement of the ancient Batticaloa Territory (Mattakallappu Desam). The bay is located 117 kilometres (73 mi) south of Batticaloa, 320 kilometres due east of Colombo, and approximately 4 kilometres south of the market town of Pottuvil. The main settlement in the area, known locally as Ullae, is predominantly Muslim."),
