...
class GirithalePage extends StatelessWidget {
  const GirithalePage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"Girithale Lake", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "Giritale tank (Sinhala: ගිරිතලේ වැව) is a reservoir in Giritale and Minneriya. It was built by King Agbo II (608-618). It is believed that the tank was renovated by King Parakramabahu, the Great (1153–1186).[2] Later, it was subjected to renovation in 1905, 1942 and 1952 during colonial era.Giritale Tank was considered as the deepest tank in Sri Lanka during the rule of medieval capital Polonnaruwa.")
