...
class MirissaPage extends StatelessWidget {
  const MirissaPage({Key? key}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            AppBoldText(
                              text: /*names[index]*/"Mirissa Beach", 
                             color:Colors.black,)
                          ],
                        ),
                        SizedBox(height: 10,),
                        ...
                        SizedBox(height: 10,),
                        AppText(text: "Mirissa is a gorgeous beach destination in Sri Lanka, and the perfect place to unwind in a hammock with a fresh coconut. The sparkling blue waters teem with marine life, from turtles to big blue whales. Secret Beach is small and secluded, and if you're lucky you might have it all to yourself.")
