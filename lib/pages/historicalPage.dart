...
class _HistoricalPageState extends State<HistoricalPage> with TickerProviderStateMixin {
  var images = {
      ...
      body: /*BlocBuilder<AppCubits, CubitStates>(
        ...
        children: [
          ...
          Container(
            ...
            child: AppBoldText(text: "Historical Places"),
          ),
          SizedBox(height: 20),
          //tabbar
          Container(
