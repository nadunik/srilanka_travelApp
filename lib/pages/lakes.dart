...
class LakesPage extends StatefulWidget {
  ...
  @override
  _LakesPageState createState() => _LakesPageState();
}

class _LakesPageState extends State<LakesPage> with TickerProviderStateMixin {
  var images = {
