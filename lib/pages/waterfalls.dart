...
class _WaterfallPageState extends State<WaterfallPage> with TickerProviderStateMixin {
  var images = {
      ...
      body: /*BlocBuilder<AppCubits, CubitStates>(
        ...
        children: [
          ...
          Container(
            ...
            child: AppBoldText(text: "Waterfalls"),
          ),
          SizedBox(height: 20),
          //tabbar
          Container(
